...
public class Calculator extends javax.swing.JFrame {
    ...
    private void jbtn1MouseClicked(java.awt.event.MouseEvent evt) {                                   
        // TODO add your handling code here:
         ...
         {
             jTextField1.setText(jbtn1.getText()); //sets first number's value to 1
                     value1 = 1;
         }
         else
         {
              jTextField1.setText( jTextField1.getText() + "" + jbtn1.getText()); //sets second number's value to 1
             value2 = 1;
         }
    }                                  
    ...
    private void jbt2MouseClicked(java.awt.event.MouseEvent evt) {                                  
        ...
        if(jTextField1.getText().isEmpty())
         {
              jTextField1.setText(jbt2.getText()); //sets first number's value to 2
                     value2 = 2;
         }
         else
         {
              jTextField1.setText( jTextField1.getText() + "" + jbt2.getText()); //sets second number's value to 2
             value2 = 2;
         }
    }                                 
    ...
    private void jbtn3MouseClicked(java.awt.event.MouseEvent evt) {                                   
        ...
        if(jTextField1.getText().isEmpty())
         {
              jTextField1.setText(jbtn3.getText()); //sets first number's value to 3
                     value1 = 3;
         }
         else
         {
              jTextField1.setText( jTextField1.getText() + "" + jbtn3.getText()); //sets second number's value to 3
             value2 = 3;
         }
    }                                  
    ...
    private void jbtn4MouseClicked(java.awt.event.MouseEvent evt) {                                   
        ...
        if(jTextField1.getText().isEmpty())
         {
              jTextField1.setText(jbtn4.getText()); //sets first number's value to 4
                     value1 = 4;
         }
         else
         {
              jTextField1.setText( jTextField1.getText() + "" + jbtn4.getText()); //sets second number's value to 4
             value2 = 4;
         }
    }                                  
    ...
    private void jbtn5MouseClicked(java.awt.event.MouseEvent evt) {                                   
        ...
        if(jTextField1.getText().isEmpty())
         {
              jTextField1.setText(jbtn5.getText()); //sets first number's value to 5
                     value1 = 5;
         }
         else
         {
              jTextField1.setText( jTextField1.getText() + "" + jbtn5.getText()); //sets second number's value to 5
             value2 = 5;
         }
    }                                  
    ...
    private void jbt6MouseClicked(java.awt.event.MouseEvent evt) {                                  
        ...
        if(jTextField1.getText().isEmpty())
         {
              jTextField1.setText(jbt6.getText()); //sets first number's value to 6
                     value1 = 6;
         }
         else
         {
              jTextField1.setText( jTextField1.getText() + "" + jbt6.getText()); //sets second number's value to 6
             value2 = 6;
         }
    }                                 
    ...
    private void jbtn7MouseClicked(java.awt.event.MouseEvent evt) {                                   
        ...
        if(jTextField1.getText().isEmpty())
         {
              jTextField1.setText(jbtn7.getText()); //sets first number's value to 7
                     value1 = 7;
         }
         else
         {
              jTextField1.setText( jTextField1.getText() + "" + jbtn7.getText()); //sets second number's value to 7
             value2 = 7;
         }
    }                                  
    ...
    private void jbtn8MouseClicked(java.awt.event.MouseEvent evt) {                                   
        ...
        if(jTextField1.getText().isEmpty())
         {
              jTextField1.setText(jbtn8.getText()); //sets first number's value to 8
                     value1 = 8;
         }
         else
         {
              jTextField1.setText( jTextField1.getText() + "" + jbtn8.getText()); //sets second number's value to 8 
             value2 = 8;
         }
    }                                  
    ...
    private void jbtn9MouseClicked(java.awt.event.MouseEvent evt) {                                   
        ...
        if(jTextField1.getText().isEmpty())
         {
              jTextField1.setText(jbtn9.getText()); //sets first number's value to 9
                     value1 = 9;
         }
         else
         {
              jTextField1.setText( jTextField1.getText() + "" + jbtn9.getText()); //sets second number's value to 9
             value2 = 9;
         }
    }                                  
    ...
    private void jbtn0MouseClicked(java.awt.event.MouseEvent evt) {                                   
        ...
        if(jTextField1.getText().isEmpty())
         {
              jTextField1.setText(jbtn0.getText()); //sets first number's value to 0
                     value1 = 0;
         }
         else
         {
              jTextField1.setText(jTextField1.getText() + "" + jbtn0.getText()); //sets second number's value to 0
             value2 = 0;
         }
    }                                  
    ...
    private void jbtnClearMouseClicked(java.awt.event.MouseEvent evt) {                                       
        // TODO add your handling code here:
        jTextField1.setText(""); //clears what is in the text field
    }                                      
    ...
    private void jbtnPlusMouseClicked(java.awt.event.MouseEvent evt) {                                      
        // TODO add your handling code here:
         if(!(jTextField1.getText().isEmpty())){
              op = "+";
        jTextField1.setText( jTextField1.getText()+ "+"); //adds the plus sign to text field
        }
    ...
    private void jbtnMinusMouseClicked(java.awt.event.MouseEvent evt) {                                       
        ...
        if(!(jTextField1.getText().isEmpty())){
              op = "-";
        jTextField1.setText( jTextField1.getText()+ "-"); //adds the minus sign to text field
        }
    }                                      
    ...
    private void jbtnMulitplyMouseClicked(java.awt.event.MouseEvent evt) {                                          
        ...
        if(!(jTextField1.getText().isEmpty())){
              op = "x";
        jTextField1.setText( jTextField1.getText()+ "x"); //adds the multiplication sign to text field
        }
    }                                         
    ...
    private void jbtnDivideMouseClicked(java.awt.event.MouseEvent evt) {                                        
        ...
        if(!(jTextField1.getText().isEmpty())){
              op = "÷";
        jTextField1.setText( jTextField1.getText()+ "÷"); //adds the division sign to text field
        }
    }                                       

    private void jbtnEqualMouseClicked(java.awt.event.MouseEvent evt) {                                       
        // TODO add your handling code here:
     //sets value of answer to 0 to start
      double answer = 0;
          //does calculation based on operator
        if(op == "+")
        ...
        { answer = value1 * value2;}
         ...
         { answer = value1 / value2;}
        //changes result to a string
         Result = Double.toString(answer);
      //shows result in text field
    ...
    //declares and initializes values and operator
